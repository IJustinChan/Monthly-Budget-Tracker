...
public class MonthlyBudget implements Writable {
    ...
    public void addIncome(Income income) {
        ...
        EventLog.getInstance().logEvent(new Event(String.format(
                    "An income of amount $%s added to day %s", income.getAmount(), income.getDay())));
    }
    ...
    public void addExpense(Expense expense) {
        ...
        EventLog.getInstance().logEvent(new Event(String.format(
                    "An expense of amount $%s added to day %s", expense.getAmount(), expense.getDay())));
    }
    ...
    public void removeIncome(int day, int amount, String source) {
        ...
        for (Income income : allIncome) {
            if (income.getDay() == day && income.getOriginalAmount() == amount 
                ...
                EventLog.getInstance().logEvent(new Event(String.format(
                            "An income of amount $%s removed from day %s", income.getAmount(), income.getDay())));
                break;
            }
            index++;
        }
